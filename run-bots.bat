@echo off
start cmd /c "python main.py --logic Keledai --email=test@email.com --name=stima --password=123456 --team etimo"
start cmd /c "python main.py --logic rakus --email=test1@email.com --name=stima1 --password=123456 --team etimo"
