...
from game.logic.keledairakus import KeledaiRakus 
from game.logic.greedyshortest import rakusjelek

init()
BASE_URL = "http://localhost:3000/api"
DEFAULT_BOARD_ID = 1
CONTROLLERS = {
    "Random": RandomLogic, "Keledai": KeledaiRakus, "rakus": rakusjelek
}
